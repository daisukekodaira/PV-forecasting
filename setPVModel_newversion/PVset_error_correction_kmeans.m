...
ShortData(:,7:13) = (shortTermPastData(:,7:13)-mean_value)./sig_value;
...
result_cluster_mean_ori=result_cluster_mean*sig_value(7)+mean_value(7);
real_demand = old_format_ShortData(:,9:104)*sig_value(7)+mean_value(7);
