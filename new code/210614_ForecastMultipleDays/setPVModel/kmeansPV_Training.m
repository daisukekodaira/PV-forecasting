function kmeansPV_Training(trainData, colPredictors, path)
    ...
    pvID = num2str(trainData.PV_ID(1)); % building number is necessary to be distinguished from other builiding mat files
    save_name = '\PV_trainedKmeans_';
    save_name = strcat(path,save_name, pvID,'.mat');
