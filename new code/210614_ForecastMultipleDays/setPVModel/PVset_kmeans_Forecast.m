...
ForecastData=forecastData(:,[1:4 7:end-3]);
...
new_version_ResultingData = horzcat(ForecastData,Result_cluster_final);
predictedPVGen = new_version_ResultingData(1:m_ForecastData,end);
end