function target = PVset_fitnet_ANN(flag,input,shortTermPastData,path)
% tic;
%% set featur
...
%     PastData_ANN(~any(PastData_ANN(:,12),2),:) = [];         % if there is 0 value in generation column -> delete
   ...
   %% load .mat file
    ...
    result_ForecastData_ANN_final = PVset_error_correction_1(ForecastData_ANN,result_ForecastData_ANN_mean,shortTermPastData);
    %% ResultingData File
